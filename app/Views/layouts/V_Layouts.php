...
<html>
  <head> 
    ...
    <!-- Choices.js-->
    <link rel="stylesheet" href="<?= base_url('') ?>/vendor/choices.js/public/assets/styles/choices.min.css">
    <!-- Google fonts - Muli-->
  ...
  <header class="header">   
    ...
    <script src="<?= base_url('') ?>/vendor/just-validate/js/just-validate.min.js"></script>
    <script src="<?= base_url('') ?>/vendor/choices.js/public/assets/scripts/choices.min.js"></script>
    <!-- Main File-->
